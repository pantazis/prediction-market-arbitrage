  ...
  "module_structure": {
    "src/predarb": {
      ...
      "submodules": {
        ...
        "testing": {
          ...
          "modules": [
            "__init__.py (exports)",
            "fake_client.py (FakePolymarketClient - in-memory, deterministic, exchange-tagging)",
        ...
        "ab_filters.py": {
          "classes": [
            ...
            "FilterResultItem (dataclass)",
            "FilterReport (dataclass)"
          ],
          "functions": [
            "evaluate_ab_filters(now_ts, kalshi_leg, polymarket_leg, trade_price_a, trade_price_b, edge_gross, config) -> FilterReport",
            "quote_from_market(market, outcome_label, depth_fraction) -> Quote"
          ],
          "purpose": "Null-safe A+B execution-safety and realism filters for post-LLM validation",
          "features": [
            "Schema mismatch detection",
            "Data integrity checks",
            "Staleness, size, price band, depth checks",
            "Edge realism vs spreads and fees",
            "Explicit PASS/FAIL reporting for Telegram"
          ]
        },
        "matchers.py": {
          "functions": [
    ...
    "tests": {
      ...
      "test_files": [
        ...
        "test_broker.py",
        "test_detectors.py",
        "test_ab_filters.py - NEW (2026-01-13): A+B filter validation",
        "test_filtering.py",
